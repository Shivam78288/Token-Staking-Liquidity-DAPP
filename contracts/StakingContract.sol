...
contract StakingContract{
    ...
    function withdraw(address investor, uint amount) external{
        require(msg.sender == reserveContract, "Only reserve contract can call this function");
        stakedTokenBalanceOf[investor] = stakedTokenBalanceOf[investor].sub(amount);
        IERC20(mindpayToken).transfer(investor, amount);
    }
